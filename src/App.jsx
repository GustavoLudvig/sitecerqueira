...
const categories = ['Masculino', 'Feminino', 'Escolha Personalizada'];
const brandFilters = [
  'Todos',
...
const products = [
  ...
  {
    id: 'custom1',
    category: 'Escolha Personalizada',
  ...
  { id: 'Masculino37', category: 'Masculino', brand: 'YSL', name: 'MY Self', variant: '60ml', price: 560, type: 'EdP' },
  { id: 'Masculino38', category: 'Masculino', brand: 'YSL', name: 'MY Self', variant: '100ml', price: 890, type: 'EdP' },
